...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { lift_id: @score.lift_id, result: @score.result, user_id: @score.user_id, wod_id: @score.wod_id }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { lift_id: @score.lift_id, result: @score.result, user_id: @score.user_id, wod_id: @score.wod_id }
    assert_redirected_to score_path(assigns(:score))
  end
