...
class WodsControllerTest < ActionController::TestCase
  ...
  test "should create wod" do
    assert_difference('Wod.count') do
      post :create, wod: { description: @wod.description, result_label: @wod.result_label, workout_id: @wod.workout_id }
    end
  ...
  test "should update wod" do
    patch :update, id: @wod, wod: { description: @wod.description, result_label: @wod.result_label, workout_id: @wod.workout_id }
    assert_redirected_to wod_path(assigns(:wod))
  end
